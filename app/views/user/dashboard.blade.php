...
<div id="dashboard">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
              ...
              <tbody><tr><td align="center"><strong><input style="font-weight: bold; font-size: 14px; min-width:400px;border-radius:5px;border:none;padding:5px;" value="{{$user->trade_key}}" readonly></strong></td></tr>
              </tbody></table>
            </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table style="border:1px solid #dddddd;" class="table table-striped">
            <tbody><tr><td align="center"><input style="font-weight: bold; font-size: 14px; min-width:400px;border-radius:5px;border:none;padding:5px;" value="{{URL::to('/')}}/referral/{{$user->username}}" readonly></td></tr>
            </tbody></table>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body text-center">
        <p><img src="https://www.gravatar.com/avatar/<?php echo md5( strtolower( trim( Confide::user()->email ) ) ); ?>" border="0" style="border-radius: 60px;" /></p>

    ...
    <nav class="navbar navbar-default navbar-fixed-top dash-navbar-top dnl-visible">
      <div class="container-sm">
        <div class="navbar-header">
          ...
          @endif
          <a class="navbar-brand" href="<?=url('/', $parameters = array(), $secure = null);?>"><img src="{{ asset('assets/img/logo.png') }}" border="0" /></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li @if(Request::is('post/security')) {{'class="active"'}} @endif>{{ HTML::link('post/security', trans('Security'), array('class' => Request::is('post/security')?'active':'')) }}</li>
             <li @if(Request::is('post/add-coin-2')) {{'class="active"'}} @endif>{{ HTML::link('post/add-coin-2', trans('Add Coin'), array('class' => Request::is('post/add-coin-2')?'active':'')) }}</li>
          </ul>
          ...
          @else
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><img src="https://www.gravatar.com/avatar/<?php echo md5( strtolower( trim( Confide::user()->email ) ) ); ?>" height="33px" border="0" style="border-radius:60px;" /> {{trans('user_texts.hello')}} {{Confide::user()->username}} <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>Welcome to GlobeCryptoMarkets!</h4>
        ...
        <p>If you are needing support please use our ticket system located here: <a href="https://support.globecryptomarkets.com" target='_blank'>Ticket Support</a></p>
        ...
        <p><em>Copyright GlobCryptoMarkets &copy; 2017. All Rights Reserved.</em></p>
      </div>

<div class="row">
  <div class="col-md-6"><h2><i class="fa fa-line-chart"></i>GlobeCryptoMarkets</h2></div>
...
<div class="@if($market_id==$btc_market->id) @endif"style="font-size:16px"><img src="{{ asset('assets/img') }}/{{{ $coinmain }}}.png" style="height:60px;"><img src="{{ asset('assets/img') }}/{{{ $coinmain }}}_{{{ $coinmain }}}.png"></div>
</ul>
<div class="pricepanel">
  ...
  <div class="col-xs-6 text-right">
    ...
    ?>
<?php
        if(strtoupper($coinsecond) == "DOGE"){
            $total_coins = isset($doge_datainfo[$market_id]['total'])? $doge_datainfo[$market_id]['total']:0; // Added by Maven
        }else{
            $total_coins = isset($btc_datainfo[$market_id]['total'])? $btc_datainfo[$market_id]['total']:0; // Added by Maven
        }
    ?>
...
<!-- <span id="spanIco-"><img src="" style="height:60px;"></span><span id="spanName"></span>-->

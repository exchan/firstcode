...
<div class="indexblock">
	<h1 style="color: #FFF; font-size: 38px; font-weight: bold; text-shadow: 1px 1px 1px #333;">Welcome to GlobeCryptoMarkets!</h1>
	<p style="text-transform: uppercase; color: #FFF; font-size: 18px; font-weight: bold; text-shadow: 1px 1px 1px #333;"> Everyone withdraw all your coins, the site will be close at 25th january,2018</p>
	<br />
	<p><a href="<?=url('/', $parameters = array(), $secure = null);?>/user/register"><button class="btn btn-lg btn-primary" >Create an Account</button></a> <a href="<?=url('/', $parameters = array(), $secure = null);?>/login"><button  class="btn btn-lg btn-success" >Login</button></a></p>
<br />
<div class="row m-auto" style="max-width: 1190px; text-shadow: 1px 1px 1px #333; color: #FFF; background-color:#444;border-radius:5px;padding:30px;opacity:0.7;">
...
<div class="col-md-3"><h3><i class="fa fa-database"></i> Low Fees</h3><p style="color: #cccccc;">At just 0.2% per trade for both BUY and SELL orders, we have some of the lowest trading fees in the industry.</p></div>
...
<div class="row m-auto m-t" style="max-width: 1190px; text-shadow: 1px 1px 1px #333; color: #FFF; font-family: 'Lato', sans-serif;background-color:#444;border-radius:5px;padding:30px;opacity:0.7;">
	<?php
	...
	$volumn_doge = (isset($statistic_doge->total) && !empty($statistic_doge->total))? sprintf('%.8f',$statistic_doge->total):0;
     ...
     ?>
<div class="row m-b">
<div class="col-md-3"><h3>Total Trades</h3><p style="font-family: 'Lato', sans-serif;font-weight:100;font-size:32px;">{{$number_doge+$number_ltc+$number_btc}}</p><em style="color: #ccc;">Last 24 hours</em></div>
<div class="col-md-3"><h3>Total BTC Volume</h3><p style="font-family: 'Lato', sans-serif;font-weight:100;font-size:32px;">{{$volumn_btc}} BTC</p><em style="color: #ccc;">Last 24 hours</em></div>
<div class="col-md-3"><h3>Total LTC Volume</h3><p style="font-family: 'Lato', sans-serif;font-weight:100;font-size:32px;">{{$volumn_ltc}} LTC</p><em style="color: #ccc;">Last 24 hours</em></div>
<div class="col-md-3"><h3>Total DOGE Volume</h3><p style="font-family: 'Lato', sans-serif;font-weight:100;font-size:32px;">{{$volumn_doge}} DOGE</p><em style="color: #ccc;">Last 24 hours</em></div>
</div>
...
<!--</p><div class="indexmarket">DOGE Markets</div><p> -->
...
<script>
	...
	$(function(){
		window.socket = {};
		socket = io.connect( 'https://globecryptomarkets.com:8081',{secure: true});
